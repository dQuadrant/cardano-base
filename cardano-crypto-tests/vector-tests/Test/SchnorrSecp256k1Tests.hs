...
import Cardano.Binary (decodeFull',DecoderError(..))
...
--TODO Find a better way to decode currently only cbor decoding is supported.
...
tests :: TestTree
tests =
    testGroup "SchnorrSecp256k1 Unit Tests" [
        signAndVerifyTest,
